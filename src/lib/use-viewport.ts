...
// Aligned with the lowered `--breakpoint-lg: 720px` token in globals.css
// so foldable phones unfolded (Galaxy Z Fold ~884, Pixel Fold ~840) and
// 720x*-class small-tablet viewports all skip the compact-hero treatment
// and get the desktop landing layout.
const COMPACT_HERO_MAX_WIDTH = 719.98;
