...
export function HelpTabs() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-[1200px] items-center gap-1 px-2 sm:px-4">
      <BackButton
        variant="ghost"
        size="icon-sm"
        ...
        {HELP_TABS.map((tab) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "relative shrink-0 px-3 py-3 text-sm font-semibold transition-colors duration-75 sm:text-base lg:text-[18px]",
                isActive
                  ? "text-[#0038F1]"
