...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer: "월세, 교육비, 인건비, 이사비처럼 성격이 다른 계약 비용도 동일한 흐름 안에서 등록하고 진행할 수 있도록 설계된 더미 FAQ입니다.",
  },
  {
    question: "계약 등록 이후 승인과 송금은 어떻게 이어지나요?",
    answer: "계약서와 증빙 자료 검토가 끝나면 승인 단계로 넘어가고, 이후 송금 요청과 처리 단계가 한 화면 안에서 이어지도록 구성된 흐름을 가정하고 있습니다.",
  },
  {
    question: "보증 체계나 안전장치는 어떻게 설명할 수 있나요?",
    answer: "서울보증보험 지급보증처럼 신뢰를 보완하는 체계를 기반으로, 거래가 끝까지 투명하게 관리된다는 메시지를 전달하는 예시 답변입니다.",
  },
  {
    question: "계약 진행 상태를 실시간으로 확인할 수 있나요?",
    answer: "요청 접수, 검수, 승인, 송금 처리처럼 각 단계를 순서대로 확인할 수 있는 운영형 화면을 상정한 더미 카피입니다.",
  },
];
...
export function SixthSection() {
  ...
  return (
    <section className="section-two-onward-font relative z-40 bg-[#f6f6f4] px-5 py-24 text-slate-950 sm:px-8 lg:px-16 lg:py-32">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-14 lg:flex-row lg:gap-24">
        <div className="lg:w-[34%]">
          ...
          <p className="mt-6 max-w-[22rem] text-base leading-[1.8] text-slate-500 sm:text-lg">
            계약 진행 흐름과 안전장치에 대해 자주 물어볼 만한 질문들을 더미 텍스트로 정리한 섹션입니다.
          </p>
        </div>
